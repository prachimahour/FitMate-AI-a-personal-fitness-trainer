...
st.set_page_config(page_title="FitMate AI : Personal Trainer", page_icon=":pushpin:", layout="wide")
...
local_css("C:\\Users\\DELL\\Desktop\\AI-fitbot\\models\\styles\\styles.css")
...
# ---- HEADER SECTION ----
with st.container():
    st.header("Hello, welcome to our website :wave:")
    st.write("---")
    html = """
    <div style="background-color:#a899e7 ;padding:20px">
    <h1 style="color:black;text-align:left;">FitMate AI : Personal Fitness Trainer 🏋🏻‍♂️🧘🏻‍♀️🤸🏼‍♂️</h1>
    <h6 style="color:black;text-align:left;">Step into a fitter future because your fitness revolution is here!<h6>
    </div>"""
    st.markdown(html, unsafe_allow_html=True)
    #st.title("FitMate AI : Personal Fitness Trainer 🏋🏻‍♂️🧘🏻‍♀️🤸🏼‍♂️")
    #st.write(
        #"Step into a fitter future : your fitness revolution is here!"
    #)
...
with st.container():
    ...
    contact_form = """
    <form action="https://formsubmit.co/mahourprachi@gmail.com" method="POST">
