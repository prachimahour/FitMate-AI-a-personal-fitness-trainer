...
<h2 style="color:black;text-align:center;">CHATBOT</h2>
</div>"""
...
def show_messages(text):
    messages_str = [
        f"<span style='color: green;'><b>USER</b>: {_['content']}</span></br>" if _['role'] == 'user' else f"<span style='color: white;'><b>FIT-BOT</b>: {_['content']}</span></br></br>"
