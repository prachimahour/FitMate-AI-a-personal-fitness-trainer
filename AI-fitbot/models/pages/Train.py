...
<h2 style="color:black;text-align:center;">Get Train here</h2>
</div>"""
st.markdown(html, unsafe_allow_html=True)    



app_mode = st.sidebar.selectbox("Choose the exercise", ["About","Left Dumbbell","Right Dumbbell","Squats","Pushups","Shoulder press","Pullups"])
if app_mode == "About":
