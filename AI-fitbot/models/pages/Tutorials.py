...
html = """
<div style="background-color:#a899e7 ;padding:10px">
<h2 style="color:black;text-align:center;">Tutorial</h2>
</div>"""
...
img5 = Image.open("./images/pullups.jpg")


app_mode = st.sidebar.selectbox("Choose text tutorial", ["About","Bicep Curls","Squats","Pushups","Shoulder press", "Pullups"])
if app_mode == "About":
    ...
    with st.container():
        image_column, text_column = st.columns((1, 2))
    with image_column:
        st.image(img5, width=325)
    with text_column:
        st.subheader("Pullups")
        st.write(
            """
            Reach Higher, Get Stronger! Elevate Your Fitness Journey with the Ultimate Upper Body Challenge!
            """
        )
        st.markdown("[Watch Video...](https://www.youtube.com/watch?v=eGo4IYlbE5g)")
...
elif app_mode == "Pullups":
    st.markdown("## Pullups")
    st.markdown("Here's a step-by-step tutorial for performing Pullups:")
    
    col1, col2 = st.columns(2)
    with col1:
        st.write("##")
        st.write("""
        - Start by standing underneath a pull-up bar with your feet shoulder-width apart.Reach up and grab the bar with an overhand grip (palms facing away from you) slightly wider than shoulder-width apart. Make sure your grip is secure.
                 
        - Hang from the bar with your arms fully extended. Engage your core, tighten your glutes, and keep your legs straight. Your shoulders should be relaxed and pulled down away from your ears.

        - Begin the movement by pulling your shoulder blades down and back. Bend your elbows and pull your body upward until your chin clears the bar. Keep your elbows close to your body throughout the movement.
                 
        - Slowly lower yourself back to the starting position with control. Fully extend your arms at the bottom of the movement. Avoid swinging or using momentum to complete the exercise. Maintain a controlled pace throughout.

        Remember, it's important to listen to your body and Breathe steadily throughout the movement, exhaling as you pull yourself up and inhaling as you lower yourself down. Gradually increase the number of reps and sets as you build strength and confidence.
        """)
    with col2:
        st.image("./gif/pullups.gif")